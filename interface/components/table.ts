...
export type CommonTableColumn<T extends object> = TextTableColumn<T> | IndexTableColumn<T> | OperationTableColumn<T> |
    ItemListTableColumn<T> | SlotsTableColumn<T> | EditableTableColumn<T> | RangeEditableTableColumn<T> | SelectionTableColumn<T>
