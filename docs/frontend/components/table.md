...
| filter-columns    | 过滤column, [CommonFormColumn](/frontend/components/form.html#commonformcolumn-表单项)    | ^[Array]`CommonFormColumn<T> []`                                                                                                            | —        |
...
| default-query     | 配置了 `fetchData` 生效                                                                   | ^[boolean]                                                                                                                                  | `true`   |
