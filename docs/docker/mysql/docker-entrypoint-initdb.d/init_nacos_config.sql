...
-- ----------------------------
INSERT INTO `config_info` (`id`, `data_id`, `group_id`, `content`, `md5`, `gmt_create`, `gmt_modified`, `src_user`, `src_ip`, `app_name`, `tenant_id`, `c_desc`, `c_use`, `effect`, `type`, `c_schema`, `encrypted_data_key`) VALUES (1, 'common.yaml', 'xh-admin', 'sys:\n  auth:\n    tokenHeaderName: auth-token\n    authTokenRedisPrefix: auth-token\n\nspring:\n  web:\n    allowedOriginPatterns:\n      - http://**\n      - https://**\n  datasource:\n    first:\n      url: jdbc:mysql://mysql8:3306/xh_admin?characterEncoding=utf-8\n      username: root\n      password: 1qaz@WSX#EDC\n      configuration:\n        maximum-pool-size: 20\n    second:\n      url: jdbc:mysql://mysql8:3306/xh_admin?characterEncoding=utf-8\n      username: root\n      password: 1qaz@WSX#EDC\n      configuration:\n        maximum-pool-size: 20\n  data:\n    redis:\n      host: redis\n      port: 6379\n      database: 0\n      timeout: 60000\n  servlet:\n    multipart:\n      max-file-size: 30MB\n      max-request-size: 30MB\n  devtools:\n    livereload:\n      enabled: true\n\n# 官方文档地址 https://springdoc.org/\nspringdoc:\n  api-docs:\n    enabled: true\n    path: /v3/api-docs\n  swagger-ui:\n    enabled: true\n    #    swagger首页地址\n    path: /swagger-ui.html\nxxl:\n  job:\n    admin:\n      ### 调度中心部署根地址 [选填]：如调度中心集群部署存在多个地址则用逗号分隔。执行器将会使用该地址进行\"执行器心跳注册\"和\"任务结果回调\"；为空则关闭自动注册；\n      addresses: http://xxl-job-admin:8088/xxl-job-admin\n    ### 执行器通讯TOKEN [选填]：非空时启用；\n    accessToken: default_token\n', '6e68f365c634d4694f57923c496a2a36', '2023-11-11 23:09:53', '2024-07-20 14:54:36', 'nacos', '117.62.169.214', '', 'production', '通用配置文件', '', '', 'yaml', '', '');
INSERT INTO `config_info` (`id`, `data_id`, `group_id`, `content`, `md5`, `gmt_create`, `gmt_modified`, `src_user`, `src_ip`, `app_name`, `tenant_id`, `c_desc`, `c_use`, `effect`, `type`, `c_schema`, `encrypted_data_key`) VALUES (2, 'system.yaml', 'xh-admin', 'minio:\n  endpoint: http://minio:9000\n  access-key: QEGiz63wnKckxgmvTwre\n  secret-key: CoWs7QBrFjsEonoFjkOx9eQhZGfE74n9VlmVNMOM\n  bucket: yanshizhan', '467c2a4092cbb22e5c3d1bb954d8716e', '2023-11-11 23:11:00', '2025-02-09 14:21:23', 'nacos', '180.109.113.101', '', 'production', '系统服务配置文件', '', '', 'yaml', '', '');
INSERT INTO `config_info` (`id`, `data_id`, `group_id`, `content`, `md5`, `gmt_create`, `gmt_modified`, `src_user`, `src_ip`, `app_name`, `tenant_id`, `c_desc`, `c_use`, `effect`, `type`, `c_schema`, `encrypted_data_key`) VALUES (3, 'generator.yaml', 'xh-admin', 'env: production', 'b34f8506bfe8b4980bf875949d423411', '2024-11-16 20:28:11', '2024-11-16 20:28:36', 'nacos', '114.222.183.205', '', 'production', '文件服务配置文件', '', '', 'yaml', '', '');
INSERT INTO `config_info` (`id`, `data_id`, `group_id`, `content`, `md5`, `gmt_create`, `gmt_modified`, `src_user`, `src_ip`, `app_name`, `tenant_id`, `c_desc`, `c_use`, `effect`, `type`, `c_schema`, `encrypted_data_key`) VALUES (4, 'common.yaml', 'xh-admin', 'sys:\n  auth:\n    tokenHeaderName: auth-token\n\nspring:\n  web:\n    allowedOriginPatterns:\n      - http://localhost:**\n      - http://demo.xhansky.cn/**\n      - http://192.168.**\n  datasource:\n    first:\n      url: jdbc:mysql://localhost:3306/bms?characterEncoding=utf-8\n      username: root\n      password: 123456\n      configuration:\n        maximum-pool-size: 20\n    second:\n      url: jdbc:postgresql://localhost:5432/bms\n      username: postgres\n      password: 123456\n      configuration:\n        maximum-pool-size: 20\n  data:\n    redis:\n      host: localhost\n      port: 6379\n      database: 0\n      timeout: 60000\n      lettuce:\n        cluster:\n          refresh:\n            adaptive: true\n            period: 20\n  servlet:\n    multipart:\n      max-file-size: 50MB\n      max-request-size: 50MB\n  devtools:\n    livereload:\n      enabled: true\nxxl:\n  job:\n    admin:\n      ### 调度中心部署根地址 [选填]：如调度中心集群部署存在多个地址则用逗号分隔。执行器将会使用该地址进行\"执行器心跳注册\"和\"任务结果回调\"；为空则关闭自动注册；\n      addresses: http://122.51.118.42:8088/xxl-job-admin\n    ### 执行器通讯TOKEN [选填]：非空时启用；\n    accessToken: default_token\n', '7b552d2591085f181671daaa037a99eb', '2023-11-30 21:17:41', '2024-12-19 21:24:02', 'nacos', '121.229.82.105', '', 'dev', '通用配置文件', '', '', 'yaml', '', '');
INSERT INTO `config_info` (`id`, `data_id`, `group_id`, `content`, `md5`, `gmt_create`, `gmt_modified`, `src_user`, `src_ip`, `app_name`, `tenant_id`, `c_desc`, `c_use`, `effect`, `type`, `c_schema`, `encrypted_data_key`) VALUES (5, 'system.yaml', 'xh-admin', 'minio:\n  endpoint: http://122.51.118.42:9000\n  access-key: QEGiz63wnKckxgmvTwre\n  secret-key: CoWs7QBrFjsEonoFjkOx9eQhZGfE74n9VlmVNMOM\n  bucket: bucket1', '5e4dd77520ad6b2325f191f8c877599b', '2023-11-30 21:17:41', '2025-01-24 10:54:18', 'nacos', '114.222.22.7', '', 'dev', '系统服务配置文件', '', '', 'yaml', '', '');
INSERT INTO `config_info` (`id`, `data_id`, `group_id`, `content`, `md5`, `gmt_create`, `gmt_modified`, `src_user`, `src_ip`, `app_name`, `tenant_id`, `c_desc`, `c_use`, `effect`, `type`, `c_schema`, `encrypted_data_key`) VALUES (6, 'generator.yaml', 'xh-admin', 'env: development', '0458986def7ccc139bd85b4bb16b1652', '2025-01-24 12:19:05', '2025-01-24 12:23:23', 'nacos', '114.222.22.7', '', 'dev', '系统服务配置文件', '', '', 'yaml', '', '');
