...
export default function (formData, validRule) {
  ...
  for (const field in validRule) {
    formPromiseArr.push(
      fieldValid(field, validRule[field], formData[field], formData)
    )
  }
